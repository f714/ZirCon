    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                <li>
                    <a href="diseases.php">Diseases List </a></li>
                <li>

                    <span class="active">Add New Disease</span>
                    ...
                    <div class="portlet box blue ">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption">
                                ...
                                <i class="fa fa-gift"></i>Create New Disease
                            </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" method="post" role="form" action="add_disease2.php"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-actions right1">
                                        <button type="button" class="btn default"
                                                onclick="window.location='diseases.php'">Cancel
                                        </button>
