...
$customers = mysqli_query($con, "select * from diseases where id='" . mysqli_real_escape_string($con, $_GET['id']) . "'");
        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    ...
                    <h1>Diseases Management

                        <small>Edit Disease</small>
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    ...
                    <a href="diseases.php">Diseases</a></li>

                <li>

                    <span class="active">Edit Disease</span>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Edit Disease
                            </div>
                        </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" method="post" role="form"
                                  action="edit_disease2.php?id=<?php echo $c['id'] ?>"
