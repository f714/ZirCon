...
include("header.php");
$sql = "select * from inspirations order by title ASC";
        ...
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    ...
                    <span class="active">Inspirations</span>
                                        ...
                                        <tr class="gradeX odd" role="row">
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <img width="150px"
                                                             src="inspiration_images/<?php echo $row['image']; ?>"/>
                                                    </div>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            <a class="" data-toggle="confirmation"
                                                               ...
                                                               href="del_inspiration.php?id=<?php echo $row['id']; ?>"
                                                               target="">
                                                        ...
                                                        <li>
                                                            <a href="edit_inspiration.php?id=<?php echo $row['id']; ?>">
